    ...
    */
    ...
    'connections' => [
        ...
        'db_read' => [
            ...
            'max_connections' => env('DB_MAX_CONNECTIONS2', 100),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                ...
                PDO::ATTR_TIMEOUT => env('DB_TIMEOUT2', 60)
            ]) : [],
        ],
        ...
        'mysql3' => [
            ...
            'max_connections' => env('DB_MAX_CONNECTIONS3', 100),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA3'),
                PDO::ATTR_TIMEOUT => env('DB_TIMEOUT3', 60)
            ]) : [],
        ],
        ...
        'db_evaluation' => [
            ...
            'max_connections' => env('DB_MAX_CONNECTIONS4', 100),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA4'),
                PDO::ATTR_TIMEOUT => env('DB_TIMEOUT4', 60)
            ]) : [],
        ],
