            ...
            <div class="col-md-12">
                ...
                <section class="np-teacher-add-form">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    {{-- <div class="col-md-4"> --}}
                                        {{-- <div class="float-right"> --}}
                                            <form class="form-inline mt-2" method="get" action="{{ route('teacher.index') }}"
                    ...
                    <div class="np-teacher-list row">
                        <div class="col-md-12">
                            <h2 class="mt-4 mb-2 np-form-title">শিক্ষক যুক্ত করুন </h2>
                        </div>
                    </div>
                    <div class="container mb-3">
                        ...
                        <form method="GET" action="{{ url()->full() }}" enctype="multipart/form-data">
                            ...
                            <div class="row np-input-form-bg mt-2">
                                <label for="beiin-psid" class="form-label">শিক্ষকের পিডিএস আইডি / ইনডেক্স নম্বর দিয়ে শিক্ষকের তথ্য খুঁজুন</label>
                                <div class="col-md-8 col-sm-8">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <button type="submit" class="btn btn-primary np-btn-form-search">তথ্য খুঁজুন <img src="{{ asset('frontend/noipunno/images/icons/arrow-right.svg') }}" alt="logo"></button>
                                    </div>
                            </div>
                                ...
                                <div class="card np-card np-profile-card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col np-card-details">
                                                <p class="np-card-title">{{@$teacher->employee_name??$teacher->employee_name_bn}} </p>
