...
@section('content')
    <div class="dashboard-section">
        ...
        <div class="container">
            <div class="row">
                <h2 class="mt-4 mb-2 np-form-title">ভার্সন যোগ করুন</h2>
                <div class="col-md-12">
                    <section class="section-teacher-add-form np-input-form-bg mb-5">
                        <div class="container">
                            <form action="{{ route('noipunno.dashboard.version.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        <div>
                                            <label for="beiin-psid" class="form-label">ভার্সনের নাম <span class="text-danger">*</span> </label>
                                            <!-- <input type="text" class="form-control np-teacher-input" id="loginId" placeholder="ভার্সনের নাম" name="version_name"> -->
                                            <div>
                                                <div class="input-group">
                                                    <select class="form-select np-teacher-input"
                                                        ...
                                                        <option value="বাংলা"
                                                            {{ old('version_name', '') == 'বাংলা' ? 'selected' : '' }}>
                                                            বাংলা ভার্সন</option>
                                                        <option value="ইংলিশ"
                                                            {{ old('version_name', '') == 'ইংলিশ' ? 'selected' : '' }}>
                                                            ইংলিশ ভার্সন</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div>
                                            ...
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input" name="branch_id"
                                                    id="branch_id" aria-label="Default select example">
