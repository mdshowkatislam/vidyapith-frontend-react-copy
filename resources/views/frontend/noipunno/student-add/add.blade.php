                                        ...
                                        <form action="{{ route('student.store') }}" id="importStudent" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-12">
                                                    <div>
                                                        <label class="form-label">ব্রাঞ্চ <span class="error">*</span></label>
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div>
                                                        <label class="form-label">শিফট <span class="error">*</span></label>
                                                        <div class="input-group">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div>
                                                        <label class="form-label">ভার্সন <span class="error">*</span></label>
                                                        <div class="input-group">
                                                ...
                                                <div class="col-md-4 col-sm-12 mt-3">
                                                    <div>
                                                        <label class="form-label">শ্রেণি <span class="error">*</span>
                                                        </label>
                                                        <div class="input-group">
                                                ...
                                                <div class="col-md-4 col-sm-12 mt-3">
                                                    <div>
                                                        <label class="form-label">সেকশন <span class="error">*</span></label>
                                                        <div class="input-group">
                                            ...
                                            <div class="row"> --}}
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="gender" class="form-label">লিঙ্গ <span class="error">*</span></label>
                                                        <div class="input-group">
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="dhormo" class="form-label">ধর্ম <span class="error">*</span></label>
                                        ...
                                        <form action="{{ route('student.import') }}" method="POST"
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    @if ($errors->has('file'))
                                                            <small
                                                                class="help-block form-text text-danger">{{ $errors->first('file') }}</small>
                                                        @endif
                                                </div>
                                            </div>
                                            <div class="row np-file-upload-demo-file-btn-container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="text-center ">
                                                        <button type="submit"
                                                            class="btn btn-primary np-btn-form-submit mt-3 bulk__import_btn">তথ্য সংযোজন করুন<img
                ...
                success: function(data) {
                    ...
                    if (data.upazilas) {
                        $.each(data.upazilas, function(index, category) {
                            $('#upazila_id').append('<option value ="' + category.uid + '">' + category
                                .upazila_name_bn +
                                '</option>');
                        });
                    }
