    ...
    <div class="dashboard-section mb-5">
        ...
        <div class="container mt-4 mb-3">
            <div class="np-teacher-list row mb-2">
                <div class="col-md-12">
                    <h2 class="np-form-title">বোর্ড রেজিস্ট্রেশনের জন্য শিক্ষার্থীর তথ্য </h2>
                </div>
            </div>
            <section class="np-teacher-add-form" id="edit-form">
                <div class="np-input-form-bg">
                    <div class="container">
                        <form method="GET" action="{{ route('student.board_registration.list') }}"
                    ...
                    <section class="np-teacher-list">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <h2 class="np-form-title">বোর্ড রেজিস্ট্রেশনের জন্য শিক্ষার্থীর তালিকা</h2>
                            </div>

                            <form method="post" action="{{ route('student.board_registration.temp.store') }}" id="copyForm">
                                @csrf
                                <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table np-table">
                                                    ...
                                                    <tbody>
                                                        <input type="hidden" name="class" value="{{@$students[0]->classRoom->class_id}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="text-center ">
                                            <button type="submit"
                                                class="btn btn-primary np-btn-form-submit mt-3">পরবর্তি
                                                ধাপ<img
