    ...
    <div class="dashboard-section mb-5">
        ...
        <div class="container mt-4 mb-3">
            <div class="np-teacher-list row mb-2">
                <div class="col-md-12">
                    <h2 class="np-form-title">পূর্ববর্তী শ্রেণির (২০২৩ সাল) শিক্ষার্থীর তথ্য </h2>
                </div>
            </div>
                    ...
                    <section class="np-teacher-list">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <h2 class="np-form-title">নতুন শ্রেণিতে (২০২৪ সাল) সংযুক্ত হওয়ার জন্য অপেক্ষমান শিক্ষার্থীর
                                    তালিকা (মোট - {{ en2bn(count(@$students)) }} জন)
                                </h2>
                            </div>
                                                        ...
                                                        @foreach ($students as $student)
                                                            <tr>
                                                                ...
                                                                <td scope="row"><span class="icon"><img
                                                                            ...
                                                                            alt=""></span>{{ @$student->student_name_en ?? @$student->student_name_bn }}
                                                                </td>
                                                                <td scope="row">
