    ...
    <div class="dashboard-section mb-5">
        ...
        <div class="container mt-4 mb-3">
            <div class="np-teacher-list row mb-2">
                <div class="col-md-12">
                    <h2 class="np-form-title">পূর্ববর্তী সেকশনের (২০২৪ সাল) শিক্ষার্থীর তথ্য </h2>
                </div>
            </div>
            <section class="np-teacher-add-form" id="edit-form">
                <div class="np-input-form-bg">
                    <div class="container">
                        <form method="GET" action="{{ route('student.section_change.list') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                    ...
                    <section class="np-teacher-list">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <h2 class="np-form-title">নতুন সেকশনে (২০২৪ সাল) সংযুক্ত হওয়ার জন্য শিক্ষার্থীর তালিকা</h2>
                            </div>

                            <form method="get" action="{{ route('student.section_changed.list') }}" id="copyForm">
                                {{-- @csrf --}}
                                <div class="col-md-12">
