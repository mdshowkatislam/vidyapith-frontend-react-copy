    ...
    <div class="dashboard-section">
        ...
        <div class="container mt-4 mb-5">
            <div class="np-teacher-list row mb-4">
                ...
                <div class="col-md-4">
                    <a class="np-route" href="{{ route('student.board_registration.temp.list_tab', $student->class ?? $student_class_info->classRoom->class_id) }}">
            ...
            <div class="tab-content" id="myTabsContent" style="border-top:2px solid #428F92">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <section class="np-teacher-add-form" id="edit-form">
                                <div class="np-input-form-bg">
                                    <div class="container">
                                        <form method="POST" action="{{ route('student.update_reg', $student->uid) }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <!-- Academic Infomation-->
                                                        <legend style="font-size:  14px"> Academic Information </legend>
                                                        <div class="col-md-6 col-sm-12 mt-3">
                                                            <div class="mb-3">
                                                                <label for="loginId" class="form-label">eSIF Serial
                                                                    No.<span class="error">*</span></label>
                                                                <input type="number" class="form-control np-teacher-input"
                                                                    name="scroll_num" value="{{ $student->scroll_num }}"
                                                                    readonly>
                                                        ...
                                                        <div class="col-md-6 col-sm-12 mt-3">
                                                            <div class="mb-3">
                                                                <label for="loginId" class="form-label">Class Roll <span
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="input-group">
                                                                    <select class="form-select np-teacher-input"
                                                                        ...
                                                                        name="version">
                                                                        <option value="">ভার্সন নির্বাচন করুন
                                                                        </option>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="input-group">
                                                                    <select class="form-select np-teacher-input"
                                                                        ...
                                                                        name="branch">
                                                                        <option value="">ব্রাঞ্চ নির্বাচন করুন
                                                                        </option>
                                                        ...
                                                        <div class="col-md-6 col-sm-12 mt-3 d-none">
                                                            <div>
                                                                ...
                                                                <div class="input-group">
                                                                    <select class="form-select np-teacher-input"
                                                                        ...
                                                                        name="class">
                                                                        <option value="">শ্রেণি নির্বাচন করুন
                                                                        </option>
                                                            ...
                                                            <div class="col-md-4 col-sm-12 mt-3 d-none">
                                                                <div>
                                                                    <label for="registration_year1" class="form-label">সন
                                                                        <span class="error">*</span></label>
                                                                    <div class="input-group">
                                                                        <input type="number"
                                                                            class="form-control np-teacher-input"
                                                                            id="registration_year1"
                                                        ...
                                                        <legend style="font-size:14px;margin-top:10px;"> Personal
                                                            Information </legend>
                                                        <div class="col-md-12 col-sm-12">
                                                            <div class="mb-3">
                                                                <label for="studentNametEnglish"
                                                                    class="form-label">Student's
                                                                    Name(ইংরেজি) <span class="error">*</span></label>
                                                                <input type="text"
                                                                    class="form-control np-teacher-input"
                                                        ...
                                                        <div class="col-md-12 col-sm-12">
                                                            <div class="mb-3">
                                                                <label for="fatherNameEnglish" class="form-label">Father's
                                                                    Name
                                                        ...
                                                        <div class="col-md-12 col-sm-12">
                                                            <div class="mb-3">
                                                                <label for="motherNameEnglish" class="form-label">Mother's
                                                                    Name
                                                                    (ইংরেজি)</label>
                                                                <input type="text"
                                                                    class="form-control np-teacher-input"
                                                        ...
                                                        <div class="col-md-12 col-sm-12 mt-3">
                                                            <div class="">
                                                                <label for="image" class="form-label">
                                                                    ছবি <small class="text-danger">300px X 80px (সাইজ
                                                                        সর্বোচ্চ 100
                                                                        KB)</small>
                                                                </label>
                                                                ...
                                                                <div class="mt-3">
                                                                    <img id="imagePreview"
                                                                        src="{{ @$student->image ? asset($student->image) : asset('path/to/default-image.png') }}"
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select np-teacher-input"
                                                            ...
                                                            name="religion">
                                                            <option value=""> Nationality নির্বাচন করুন</option>
                                                        ...
                                                        {{-- @if ($errors->has('nationality'))
                                                            <small
                                                                class="help-block form-text text-danger">{{ $errors->first('nationality') }}</small>
                                                        @endif --}}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="dhormo" class="form-label">Religion <span
                                                                class="error">*</span></label>
                                                        {{-- <input type="text" class="form-control np-teacher-input" id="dhormo" name="religion" value="{{$student->religion}}"> --}}
                                                        <select class="form-select np-teacher-input"
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="gender" class="form-label">Sex <span
                                                                class="error">*</span></label>
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
...
@endphp --}}
                                                    <input type="date" class="form-control np-teacher-input"
                                                        id="birthday" name="date_of_birth"
                                                        max="{{ date('Y') - 10 }}-12-31"
                                                        min="{{ date('Y') - 20 }}-01-01"
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="BRID" class="form-label">জন্ম নিবন্ধন
                                                            নং</label>
                                                ...
                                                <div class="col-md-4 col-sm-12 mb-3">
                                                    <div class="">
                                                        <label for="br_file" class="form-label">জন্ম নিবন্ধন ফাইল
                                                        </label>
                                                ...
                                                <!-- Make group Box For Adddress  -->

                                                <legend style="font-size:  14px"> Address Information </legend>
                                                <div class="col-md-4 col-sm-12 mb-3">
                                                    <div class="">
                                                ...
                                                <div class="col-md-4 col-sm-12 mb-3">
                                                    <div class="">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                data-toggle="tooltip" data-placement="top" title="জেলা"
                                                ...
                                                <div class="col-md-4 col-sm-12 mb-3">
                                                    <div class="">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                data-toggle="tooltip" data-placement="top" title="উপজেলা"
                                                ...
                                                <legend style="font-size:  14px"> Additional Information </legend>
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    <div class="form-group">
                                                        <label for="inputEmail3"
                                                            class="col-sm-12 control-label text-left">Disability
                                                            types(Optional)</label>
                                                        <div class="col-sm-12">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" value="speech_impaired"
                                                                        name="disability_types[]" @if(is_array(json_decode($student->disability_types)) && in_array('speech_impaired',json_decode($student->disability_types))) {{'checked'}} @endif>
                                                                    Speech impaired
                                                                </label>
                                                                <label>
                                                                    <input type="checkbox" value="visually_impaired"
                                                                        name="disability_types[]" @if(is_array(json_decode($student->disability_types)) && in_array('visually_impaired',json_decode($student->disability_types))) {{'checked'}} @endif>
                                                                    Visually impaired
                                                                </label>
                                                                <label>
                                                                    <input type="checkbox" value="hearing_impaired"
                                                                        name="disability_types[]" @if(is_array(json_decode($student->disability_types)) && in_array('hearing_impaired',json_decode($student->disability_types))) {{'checked'}} @endif>
                                                                    Hearing impaired
                                                                </label>
                                                                <label>
                                                                    <input type="checkbox" value="physically_impaired"
                                                                        name="disability_types[]" @if(is_array(json_decode($student->disability_types)) && in_array('physically_impaired',json_decode($student->disability_types))) {{'checked'}} @endif>
                                                                    Physically impaired
                                                                </label>
                                                                <label>
                                                                    <input type="checkbox" value="mentally_impaired"
                                                                        name="disability_types[]" @if(is_array(json_decode($student->disability_types)) && in_array('mentally_impaired',json_decode($student->disability_types))) {{'checked'}} @endif>
                                                                    Mentally impaired
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    <div class="">
                                                        <label for="disability_file" class="form-label">Disability
                                                            file(Only jpg)
                                                        </label>
