    ...
    <div class="dashboard-section mb-5">
        ...
        <div class="container mt-4 mb-3">
            <div class="np-teacher-list row mb-2">
                <div class="col-md-12">
                    <h2 class="np-form-title">ছাড়পত্র প্রদানের জন্য শিক্ষার্থীর তথ্য </h2>
                </div>
            </div>
            <section class="np-teacher-add-form" id="edit-form">
                <div class="np-input-form-bg">
                    <div class="container">
                        <form method="GET" action="{{ route('student.issue.transfer.list') }}"
                    ...
                    <section class="np-teacher-list">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <h2 class="np-form-title">শিক্ষার্থীর তালিকা (মোট - {{ en2bn(count(@$students)) }} জন)
                                </h2>
                            </div>

                            {{-- <form method="get" action="{{ route('student.promoted.list') }}" id="copyForm"> --}}
                            {{-- @csrf --}}
                            <div class="col-md-12">
                                                    ...
                                                    @foreach ($students as $student)
                                                        <tr>
                                                            ...
                                                            <td scope="row"><span class="icon"><img
                                                                        ...
                                                                        alt=""></span>{{ @$student->student_info->student_name_en ?? @$student->student_info->student_name_bn }}
                                                            </td>
                                                            <td scope="row">
                                                                {{ @$student->student_info->father_name_en ?? @$student->student_info->father_name_bn }}
                                                            </td>
                                                            <td>
                                                                @if ($student->rec_status != 2)
                                                                    <a class="np-route transfer_student"
                                                                        href="{{ route('student.issue.transfer.add', $student->student_uid) }}">
                                                                        <button class="btn np-edit-btn-small"
                                                                            style="font-size: 12px; width: 85px !important; color: #fff;">ছাড়পত্র দিন</button>
                                                                    </a>
                                                                @else
                                                                    <a href="{{ route('student.issue.transfer.certificate.generate', $student->student_uid) }}"
                                                                        class="np-route" target="_blank">
                                                                        <button class="btn np-delete-btn-small"
                                                                            style="font-size: 12px; width: 85px !important; color: #fff;">ছাড়পত্র দেখুন
                                                                        </button>
                                                                    </a>
                                                                @endif
                                                            </td>
                                                            {{-- <td scope="row">{{ @$student->registration_year }}</td> --}}
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
