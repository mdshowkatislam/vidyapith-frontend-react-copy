    ...
    <div class="dashboard-section">
        ...
        <div class="container mt-4 mb-5">
            <div class="np-teacher-list row mb-2">
                <div class="col-md-12">
                    <h2 class="np-form-title">ছাড়পত্র প্রদানের জন্য শিক্ষার্থীর তথ্য অনুসন্ধান করুন</h2>
                </div>
            </div>
            <section class="np-teacher-add-form" id="edit-form">
                <div class="np-input-form-bg">
                    <div class="container">
                        <form method="GET" action="{{ route('student.issue.transfer.list') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
