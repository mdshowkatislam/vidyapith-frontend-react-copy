...
@section('content')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-5 np-student-form-download-btn">
                        <button class="np-btn np-btn-primary np-btn-with-icon np-student-form-download-btn">
                            <a href="{{ route('student.download') }}" target="_blank" class="np-file-upload-demo-file-btn"
                                download>একাধিক শিক্ষার্থী আপলোড করার নমুনা ডাউনলোড করুন</a>
                                            ...
                                            @foreach ($students as $student)
                                                <tr>
                                                    <td scope="row"><span class="icon"><img
                                                                ...
                                                                alt=""></span>{{ @$student->roll }}</th>
                                                    <td scope="row">
                                                        {{ @$student->student_name_en ?? @$student->student_name_bn }}</th>
                                                    <td scope="row">
                                                        @if (@$student->class == 6)
                                                            Class Six
                                                    ...
                                                    <td scope="row">{{ @$student->mother_name_bn }} </th>
                                                    <td scope="row">{{ @$student->father_name_bn }}</th>
                                                    <td scope="row">{{ @$student->brid }}</th>
                                                    <td scope="row">
                                                        @if ($student->date_of_birth)
                                                            {{ date('j F, Y', strtotime(@$student->date_of_birth)) }}</th>
                                                        @endif
                                                    <td scope="row">
                                                        <div class="action-content">
                                                            ...
                                                            <a class="btn np-delete-btn-small" id="delete" title="Delete"
                                                                data-id="{{ $student->uid }}"
                                ...
                                <div class="np-input-form-bg">
                                        ...
                                        <form action="{{ route('student.store') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-12 mt-3">
                                                    <div>
                                                        <label for="class1" class="form-label">ক্লাস <span
                                  ...
                                  <option value="2024" @if (old('registration_year') == 2024) selected @endif>2024</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="fatherName" class="form-label">পিতার নাম (বাংলা) <span
                                                                class="error">*</span></label>
                                                        <input type="text" class="form-control np-teacher-input"
    ...
    @endif -->
                                <section class="np-teacher-add-form">
                                    <div class="np-input-form-bg">
                                        <form action="{{ route('student.import') }}" id="importStudent" method="POST"
                                            enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-12">
                                                    <div>
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                aria-label="Default select example" id="branch2"
                                                                name="branch">
                                                                <option value="">Select Branch</option>
                                                                @foreach ($branchs as $branch)
                                                                    <option value="{{ @$branch->uid }}">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div>
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                aria-label="Default select example" id="shift2"
                                                                name="shift">
                                                                <option value="">Select Shift</option>
                                                                @foreach ($shifts as $shift)
                                                                    <option value="{{ @$shift->uid }}">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div>
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                aria-label="Default select example" id="version2"
                                                                name="version">
                                                                <option value="">Select Version</option>
                                                                @foreach ($versions as $version)
                                                                    <option value="{{ @$version->uid }}">
                                                ...
                                                <div class="col-md-4 col-sm-12 mt-3">
                                                    <div>
                                                        <label for="class2" class="form-label">ক্লাস <span
                                                                class="error">*</span> </label>
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                aria-label="Default select example" id="class2"
                                                                name="class">
                                                                <option value="">Select Class</option>
                                                                @foreach ($classList as $class)
                                                                    <option value="{{ $class['class_id'] }}"
                                                                        {{ old('class') == $class['class_id'] ? 'selected' : '' }}>
                                                                        {{ $class['name_en'] }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-md-4 col-sm-12 mt-3">
                                                    <div>
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select np-teacher-input"
                                                                aria-label="Default select example" id="section2"
                                                                name="section">
                                                                <option value="">Select Section</option>
                                                                @foreach ($sections as $section)
                                                                    <option value="{{ @$section->uid }}">
                                  ...
                                  <option value="2024" @if (old('registration_year') == 2024) selected @endif>2024</option>
                                            ...
                                            <div class="row np-file-upload-demo-file-btn-container">
                                                ...
                                                <div class="col-md-5">
                                                    <a href="{{ route('student.download') }}" target="_blank"
                                                        class="np-file-upload-demo-file-btn" download>একাধিক শিক্ষার্থী
                                                        আপলোড করার নমুনা ডাউনলোড করুন</a>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="text-center ">
                                                        <button type="submit"
                                                            class="btn btn-primary np-btn-form-submit mt-3">তথ্য সংযোজন
                                                            করুন<img
        ...
        function fetchDataForBranch(id) {
            $.ajax({
                ...
                success: function(data) {
                    $('#version1').empty();
                    $.each(data.versions, function(key, value) {
                        $('#version1').append('<option value="' + value.uid + '">' + value
                            .version_name + '</option>');
                    });
                    $('#shift1').empty();
                    $.each(data.shifts, function(key, value) {
                        $('#shift1').append('<option value="' + value.uid + '">' + value.shift_name +
                            '</option>');
                    });
                }
            }, "json");
        ...
        function fetchDataForSection(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('#section1').append('<option value="' + value.uid + '">' + value
                            .section_name + '</option>');
                        $('#registration_year1').val(value.section_year)
                    });
                }
        ...
        function fetchDataForBranch2(id) {
            $.ajax({
                ...
                success: function(data) {
                    $('#version2').empty();
                    $.each(data.versions, function(key, value) {
                        $('#version2').append('<option value="' + value.uid + '">' + value
                            .version_name + '</option>');
                    });
                    $('#shift2').empty();
                    $.each(data.shifts, function(key, value) {
                        $('#shift2').append('<option value="' + value.uid + '">' + value.shift_name +
                            '</option>');
                    });
                }
            }, "json");
        ...
        function fetchDataForSection2(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#registration_year2').empty();
                    $.each(data, function(key, value) {
                        $('#section2').append('<option value="' + value.uid + '">' + value
                            .section_name + '</option>');
                        $('#registration_year2').val(value.section_year)
                    });
                }
