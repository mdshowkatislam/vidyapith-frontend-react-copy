...
@section('content')
    <div class="dashboard-section">
                                                    ...
                                                    @foreach ($shiftList as $shift)
                                                        <tr>
                                                            <td scope="row"><span class="icon"> <img
                                                                        ...
                                                                        alt=""></span>{{ @$shift->shift_name_en ?? @$shift->shift_name_bn }}
                                                            </td>
                                                            ...
                                                            <td scope="row"><input type="time"
                                                                    value="{{ @$shift->shift_start_time }}" disabled
                                                                    style="background: #FFF; border: unset; color: #000;" />
                                                            </td>
                                                            <td scope="row"><input type="time"
                                                                    value="{{ @$shift->shift_end_time }}" disabled
                                                                    style="background: #FFF; border: unset; color: #000;" />
                                                            </td>
        ...
        <div class="container">
            <div class="row">
                <h2 class="mt-4 mb-2 np-form-title">শিফট যোগ করুন </h2>
                                            ...
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input"
                                                    ...
                                                    <option value="প্রভাতি"
                                                        {{ old('shift_name', '') == 'প্রভাতি' ? 'selected' : '' }}>প্রভাতি
                                                    </option>
                                                    <option value="দিবা"
                                                        {{ old('shift_name', '') == 'দিবা' ? 'selected' : '' }}>দিবা </option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input"
                                                    ...
                                                    <option value="co-education"
                                                        {{ old('shift_details', '') == 'co-education' ? 'selected' : '' }}>
                                                        কো-এডুকেসন </option>
                                                    <option value="girls"
                                                        {{ old('shift_details', '') == 'girls' ? 'selected' : '' }}>বালিকা
                                                    </option>
                                                    <option value="boys"
                                                        {{ old('shift_details', '') == 'boys' ? 'selected' : '' }}>বালক
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
