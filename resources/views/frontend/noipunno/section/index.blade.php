...
@section('content')
    <div class="dashboard-section"> {{-- Top section starts --}}
            ...
            <div class="container">
              ...
              @endif --}}
                    ...
                    <div class="col-md-12 mt-5">
                      <div class="alert alert-danger" role="alert">
                        <strong>Please remove all subject teacher that are related with this section before removing this section</strong>
                      </div>
                    </div>
                  @endif
                  ...
                  @if (Session::has('student_items') && count(Session::get('student_items')) > 0)
                    <div class="col-md-12 mt-2">
                      <div class="alert alert-danger" role="alert">
                        <strong>Please remove all students that are related with this section before removing this section</strong>
                      </div>
                    </div>
                  @endif --}}
        ...
        <div class="container">
            <div class="row">
                <h2 class="mt-4 mb-2 np-form-title">সেকশন যোগ করুন </h2>
                <div class="col-md-12">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        <div>
                                            <label for="branch_id" class="form-label">ব্রাঞ্চ <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input" id="branch_id"
                                                    aria-label="Default select example" name="branch_id">
                                                    {{-- <option value="">ব্রাঞ্চ নির্বাচন করুন</option> --}}
                                                    @foreach ($branchList as $branch)
                                                        <option value="{{ @$branch->uid }}"
                                                            {{ old('branch_id', '') == @$branch->uid ? 'selected' : '' }}>
                                                            {{ @$branch->branch_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div>
                                            <label for="version_id" class="form-label">ভার্সন <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input" id="version_id"
                                                    aria-label="Default select example" name="version_id">
                                ...
                                @endforeach --}}
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div>
                                            <label for="shift_id" class="form-label">শিফট <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input" id="shift_id"
                                ...
                                @endforeach --}}
                                    ...
                                    <div class="col-md-4 col-sm-12 mt-5">
                                        <div>
                                            <label for="beiin-psid" class="form-label">শ্রেণি <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-md-4 col-sm-12 mt-5 d-none">
                                        <div>
                                            ...
                                            <select class="form-select np-teacher-input"
                                                ...
                                                <option value="2023"
                                                    {{ old('section_year', '') == '2023' ? 'selected' : '' }}>2023</option>
                                                <option value="2024"
                                                    {{ old('section_year', '') == '2024' ? 'selected' : '' }}>2024</option>
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 d-flex justify-content-start">
                                    <button type="submit"
                                        ...
                                        style="width: fit-content;border: unset;column-gap: 10px;">তথ্য সংযোজন করুন <img
