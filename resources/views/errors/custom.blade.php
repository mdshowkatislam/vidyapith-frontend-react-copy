...
<body>
    ...
    <div class="d-flex flex-column flex-root">
        <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('metronic/assets/media/bg/bg-3.jpg');">
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    <div class="card" style="border:none;">
                        <div class="row justify-content-center">
                            <div class="row no-gutters">
                                <div class="login-form col-lg-12 d-flex flex-column position-relative shadow">
                                    <div class="kt-login__signin p-10 mb-auto">
                                        <div>
                                            <div class="alert alert-danger">{!! @$problem['exception_name'] !!}</div>
                                            <table class="table table-bordered">
                                                <tr><td class="text-right">সমস্যার ধরণঃ  </td><td class="text-left">{!! @$problem['title'] !!}</td></tr>
                                                <tr><td class="text-right">সমস্যার বর্ণনাঃ </td><td class="text-left">{!! @$problem['message'] !!}</td></tr>
                                                <tr><td class="text-center" colspan="2">  <a href="/">হোম পেইজ-এ যান</a></td></tr>
                                            </table>
                                        </div>
                                    </div>
                                </div>
