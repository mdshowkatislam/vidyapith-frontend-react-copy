...
namespace App\Http\Requests\ExamConfigure;
...
class ExamConfigureUpdateRequest extends FormRequest
{
    use ApiResponser;
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'class_id' => 'nullable',
            'section_id' => 'required',
            'exam_category_id' => 'required_unless:exam_type,term_exam,final_exam',
            ...
            'exam_date' => 'required',
            'exam_time' => 'required_unless:exam_type,assignment|max:100',
