...
class InventoryCategoryUpdateRequest extends FormRequest
{
    use ApiResponser;
    /**
    ...
    {
        return [
            'shift_name_en.required' => 'অনুগ্রহ করে ক্যাটাগরি নাম প্রদান করুন।',
            'shift_name_en.unique' => 'একই ক্যাটাগরি একাধিকবার দেয়া সম্ভব না।',
