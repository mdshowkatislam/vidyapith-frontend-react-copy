...
class TeacherStoreRequest extends FormRequest
{
    ...
    {
        return [
            'name_en.required' => 'অনুগ্রহ করে শিক্ষকের নাম প্রদান করুন।',
            'designation.required' => 'অনুগ্রহ করে শিক্ষকের পদবি প্রদান করুন।',
            ...
            'image.max' => 'ছবির সাইজ সর্বোচ্চ হবে 500 KB',
