...
class InventoryStoreStoreRequest extends FormRequest
{
    use ApiResponser;
    /**
    ...
    {
        return [
            'name_en.required' => 'অনুগ্রহ করে স্টোর নাম প্রদান করুন।',
            'name_en.unique' => 'একই স্টোর একাধিকবার দেয়া সম্ভব না।',
