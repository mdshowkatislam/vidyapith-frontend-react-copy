...
namespace App\Http\Requests\InventoryShelves;
...
class InventoryShelvesUpdateRequest extends FormRequest
{
    use ApiResponser;
    /**
    ...
    {
        return [
            'shift_name_en.required' => 'অনুগ্রহ করে রেক নাম প্রদান করুন।',
            'shift_name_en.unique' => 'একই রেক একাধিকবার দেয়া সম্ভব না।',
