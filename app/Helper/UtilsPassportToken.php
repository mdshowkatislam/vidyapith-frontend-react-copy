...
class UtilsPassportToken
{
    ...
    public static function dirtyDecode($access_token, $claims = array())
    {
        ...
        $decodedToken =  array(
            ...
            'user_phone_no' => (isset($data->phone_no)) ? $data->phone_no : null,
            'user_caid' => (isset($data->caid)) ? $data->caid : null,
            'user_eiin' => (isset($data->eiin)) ? $data->eiin : null,
            'user_pdsid' => (isset($data->pdsid)) ? $data->pdsid : null,
            'user_suid' => (isset($data->suid)) ? $data->suid : null,
            'user_role' => (isset($data->role)) ? $data->role : null,
            'user_user_type_id' => (isset($data->user_type_id)) ? $data->user_type_id : null,
            'user_board_id' => (isset($data->board_id)) ? $data->board_id : null,
            'user_upazila_id' => (isset($data->upazila_id)) ? $data->upazila_id : null,
            'user_district_id' => (isset($data->district_id)) ? $data->district_id : null,
            'user_division_id' => (isset($data->division_id)) ? $data->division_id : null,
            'expecting' => $expecting,
