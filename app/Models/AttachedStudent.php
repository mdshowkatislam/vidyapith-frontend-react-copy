...
class AttachedStudent extends Model
{
    ...
    {
        return $this->belongsTo(ClassRoom::class, 'old_class_room_uid', 'uid')->select(['uid', 'eiin', 'class_teacher_id', 'class_id', 'section_id', 'branch_id', 'shift_id', 'version_id', 'session_year']);
    }
