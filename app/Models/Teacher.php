...
class Teacher extends Model implements AttendableInterface
{
    ...
    const SHORT_SELECT_FIELDS = [
        'id', 'uid', 'emp_id', 'name_en', 'name_bn',
        'email', 'mobile_no', 'gender', 'designation',
        'division_id', 'district_id', 'upazilla_id', 'address'
    ];
    ...
    protected static function boot()
    {
        ...
        static::updated(function ($teacher) {
            $cacheKey = 'teacher_short_' . $teacher->emp_id;
    ...
    {
        return $this->hasMany(SubjectTeacher::class, 'teacher_uid', 'uid');
    }
