...
return new class extends Migration
{
    ...
    {
        Schema::create('bi_weekly_tests', function (Blueprint $table) {
            $table->id();
            ...
            // $table->unique(['branch_id', 'shift_id', 'version_id', 'class_id', 'section_id', 'subject_code', 'exam_name'], 'unique_bi_weekly_test_name');
        });
    }
    ...
    {
        Schema::dropIfExists('bi_weekly_tests');
    }
};
